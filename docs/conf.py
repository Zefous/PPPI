...
import os
import sys
sys.path.insert(0, os.path.abspath('../gui'))  # Указываем путь к корню проекта
sys.path.insert(0, os.path.abspath('../missions'))
sys.path.insert(0, os.path.abspath('../upgrades'))

project = 'PPPI_DMC'
copyright = '2025, Kirill Medvedev'
